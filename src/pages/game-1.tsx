...
function App() {
  ...
  if (!session){
    return (
      <div className="flex gap-12 flex-col w-full min-h-screen font-sans font-semibold items-center justify-center">
    ...
    >
      ...
      {attempts < 3 ? (
        <>
          ...
          <div
            className="absolute h-16 w-16 cursor-pointer rounded-full bg-cover bg-center"
            style={{
              top: `${position.top}px`,
              left: `${position.left}px`,
              backgroundImage: `url('https://i.pinimg.com/564x/3c/32/fc/3c32fc5df675e77467b0343ea7b46dbb.jpg')`,
